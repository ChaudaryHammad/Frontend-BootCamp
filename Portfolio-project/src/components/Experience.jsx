...
const Experience = () => {
  return (
   ...
   <motion.h1  whileInView={{opacity:1,y:0}} initial={{opacity:0,y:-100}} transition={{duration:1.5}} className="my-20 text-center text-4xl underline decoration-wavy decoration-purple-500">My<span className="text-neutral-500 font-light"> Experience</span></motion.h1>
   <div>
    {
