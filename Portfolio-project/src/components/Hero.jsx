          ...
          <div className="w-full lg:w-1/2">
            <div className="flex flex-col items-center lg:items-start">
              <motion.h1 variants={container(0)} initial="hidden" animate="visible"
               className="mb-5 text-6xl font-thin tracking-tight lg:mt-16 lg:text-7xl lg:text-left text-center">
                Muhammad Hammad
              </motion.h1>
              <motion.span variants={container(0.5)} initial="hidden" animate="visible" 
              className="bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-[23px] lg:text-2xl tracking-tight text-transparent lg:text-left text-center">
